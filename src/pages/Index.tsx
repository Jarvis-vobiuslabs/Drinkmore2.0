...
const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 md:px-28 py-4">
    <div className="flex items-center gap-2">
      <Droplet className="w-7 h-7 text-foreground/80" />
      <span className="text-foreground font-bold text-lg">Drink More</span>
    </div>
...
const Hero = () => (
  <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-10 text-center px-6 pt-28 md:pt-32 max-w-4xl mx-auto">
      ...
      <motion.p {...fadeUp(0.2)} className="text-lg mb-10" style={{ color: "hsl(var(--hero-subtitle))" }}>
        Smart reminders that help you build the habit of drinking enough water every day.
      </motion.p>

      <motion.div {...fadeUp(0.3)} className="liquid-glass rounded-full p-2 max-w-lg mx-auto flex items-center">
        <input
          type="email"
          placeholder="Enter your email"
          className="flex-1 bg-transparent border-none outline-none px-4 py-2 text-foreground placeholder:text-muted-foreground text-sm"
        />
        <motion.button
...
const StatsSection = () => (
  <section id="how-it-works" className="px-8 md:px-28 pt-52 md:pt-64 pb-6 md:pb-9">
...
const MissionSection = () => (
  <section className="px-8 md:px-28 pt-0 pb-32 md:pb-44">
...
const FeaturesSection = () => (
  <section id="features" className="px-8 md:px-28 py-32 md:py-44 border-t border-border/30">
    <motion.p {...fadeUp(0)} className="text-xs tracking-[3px] uppercase text-muted-foreground mb-4">FEATURES</motion.p>
    <motion.h2 {...fadeUp(0.1)} className="text-4xl md:text-6xl font-medium tracking-[-1px] mb-16">
...
const CTASection = () => {
  ...
  return (
    <section id="download" className="relative px-8 md:px-28 py-32 md:py-44 border-t border-border/30 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <motion.h2 {...fadeUp(0.1)} className="text-4xl md:text-6xl font-medium tracking-[-1px] mb-6">
...
/* ─── Footer ─── */
const Footer = () => (
  <footer className="flex flex-col md:flex-row items-center justify-between py-12 px-8 md:px-28 text-muted-foreground text-sm">
